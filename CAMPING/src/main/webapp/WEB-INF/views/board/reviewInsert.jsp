			...
			<div class="row">
				<div class="col-sm-7">
					<label for="ID" style="font-size: 20px; font-weight: bold;">
						제목</label> <input type="text" id="title" name="rv_title"
						style="background-color: white; color: black;" required="required"><br>
				</div>
			</div>
			<textarea id="content" name="rv_content" class="summernote"
			...
			<c:if test="${role ne 'ROLE_GUEST' }">
				<div style="padding-top: 1%; float: right;">
					<input type="button" value="목록" class="btn btn-dark btn-sm"
						...
						onclick="location.href='/board/review.do'"> <input
						type="submit" value="전송" class="btn btn-primary btn-sm"
						formaction="/board/reviewInsertOk.do">
				</div>
			</c:if>
		</form>
	</section>
