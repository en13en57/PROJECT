...
<body class="is-preload landing">
      ...
      <div style="padding-top: 70px; padding-left: 10%">
         ...
         <div class="col-sm-2" style="float: left;">
            <select name="list" id="list" onchange="window.open(value,'_self');">
               <option value="/baord/notice.do" >공지사항</option>
      ...
      <section
         ...
         <sec:csrfInput />
          ...
          <textarea id="content" name="qna_content" style="height:250px;color:black; background-color: white;" required="required">내용을 작성하여 주세요</textarea>

           <c:if test="${role ne 'ROLE_GUEST' }">
           <div style="padding-top: 1%; float: right;">
            <input  value="목록" class="btn btn-dark btn-sm" type="button" style="margin-right: 2px;" onclick="location.href='/board/QnA.do'" >
