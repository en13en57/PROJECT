					...
					<form action="/insertOk.do" method="post"
						...
						<div style="width: 50%;">
							...
							<div class="mb-4 row">
								...
								<!-- socialID는 회원 프로필로 가져오고 socialNumber는 어느 소셜인지 판단  -->
								<input type="hidden" name="socialID"
									value="${memberVO.socialID }" /> <input type="hidden"
									name="socialNumber" value="${memberVO.socialNumber }" />
								<div class="col-sm-3">
							...
							<div class="mb-4 row">
								<label for="username" class="col-sm-3 col-form-label">
									이름</label>
								<c:choose>
									<c:when test="${memberVO.mb_name ne null }">
										<div class="col-sm-5">
											<input type="text" id="username" name="mb_name"
												placeholder="이름 입력" required maxlength="4"
												value="${memberVO.mb_name }" readonly="readonly">
										</div>
									</c:when>
									<c:otherwise>
										<div class="col-sm-5">
											<input type="text" id="username" name="mb_name"
												placeholder="이름 입력" required maxlength="4" value="">
										</div>
									</c:otherwise>
								</c:choose>
							</div>
							...
							<div class="mb-4 row">
								...
								<div class="col-sm-5">
									<input type="text" id="email" name="mb_email"
										placeholder="example@ex.com" required
										value="${memberVO.mb_email }" readonly="readonly">
								</div>
							</div>
							...
							<!-- 소셜마다 받아오는 정보가 달라, 생년월일 가져올경우와 못가져올 경우로 나뉜다 -->
							<div class="mb-4 row">
									...
									<c:when test="${memberVO.mb_birth ne null }">
										<div class="col-sm-5">
											...
											<input type="text" id="birthYear" name="mb_birth"
												placeholder="" value="${memberVO.mb_birth }" required
