				...
				<div id="member_position">
					<div class="mb-4">
						<div style="width: 70%;">
							...
							<br>
							<table class="table table-dark" style="color: white; border: 1px solid white; border-radius: 10px;">
								<tr>
									<th colspan="2" style="color: white; background-color: black; vertical-align: middle;">${mvo.mb_name }님의
										정보입니다.</th>
								</tr>

								<tr>
									<td class="td-1" style="">아이디</td>
									<td class="td-2">${mvo.mb_ID }</td>
								</tr>

								<tr>
									<td class="td-1">비밀번호</td>
									<td class="td-2">${mvo.mb_password }</td>
								</tr>

								<tr>
									<td class="td-1">이름</td>
									<td class="td-2">${mvo.mb_name }</td>
								</tr>

								<tr>
									<td class="td-1">닉네임</td>
									<td class="td-2">${mvo.mb_nick }</td>
								</tr>

								<tr>
									<td class="td-1">이메일</td>
									<td class="td-2">${mvo.mb_email }</td>
								</tr>

								<tr>
									<td class="td-1" style="vertical-align: middle;">주소</td>
									<td class="td-2">${mvo.mb_zipcode }<br> ${mvo.mb_address1 } <br>
										${mvo.mb_address2 }
									</td>
								</tr>
							</table>
							<div style="float: right;">
								<button type="button" id="membercorrect" class="btn btn-primary"
									onclick="membercorrect();">수정하기</button>
								<button type="button" id="memberdelete" class="btn btn-danger"
