...
<body class="is-preload landing">
	...
	<div style="padding-top: 70px; padding-left: 10%">
		...
		<div id="selectfst" class="col-sm-2"
			...
			<select name="list" id="list" onchange="window.open(value,'_self');">
				...
				<option value="/camp/carCampground.do" selected>자동차야영장</option>
	...
	<div>
		<p
			style="font-size: 50px; padding-left: 12%; padding-top: 5%; font-weight: bold;">자동차야영장</p>
	</div>
<!-- 	<div style="padding-right: 7%; padding-bottom: 3%;">
	...
	<script>
		...
		function test() {
			$.ajax({
				type : "post",
				url : "/camp/selectcarCampground.do",
				dataType : "json",
