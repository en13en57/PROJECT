...
import pro.s2k.camp.service.NaverLoginApi;
...
public class NaverLoginBO {
    ...
    private final static String CLIENT_ID = "eT2NCIHgedo2uVebssZm";       //네이버API Client ID
    private final static String CLIENT_SECRET = "dBx60NTCAZ";                      
