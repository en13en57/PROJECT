...
<link rel="shortcut icon" type="image/x-icon"
	href="assets/css/images/logo.png" />
...
<body class="is-preload landing">
	<div id="page-wrapper">
		...
		<header id="header">
			<h1 id="logo">
				<a href="index.jsp"><img src="assets/css/images/logo.png" alt="" />
				</a>
			</h1>
			<nav id="nav">
				<ul>
		...
		<section id="banner">
			<div class="content">
				<header class="hightitle">
					<h2>캠핑은 NG캠핑!</h2>
					<p>
						여러분의 캠칭생활을 도와드립니다!<br /> 아래의 화살표를 누르시면 캠핑정보를 확인할 수 있습니다.
					</p>
				</header>
	...
	<div style="position: fixed; bottom: 10px; right: 10px; z-index: 100;">
		<a href="#banner" style="text-decoration: underline;"><img
			src="assets/css/images/top.png"></a>
	</div>
</body>
</html>